...
The Apt module has an example task that allows a user to run apt-get update or upgrade. Please refer to to the PE documentation or Bolt documentation on how to execute a task.
